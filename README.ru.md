...
Больше не нужно ограничиваться одной скрытой проксей: можно **сохранять
несколько прокси, давать им названия, переключать активную из списка и удалять
ненужные**. Ранее скрытую встроенную (приходящую с бэкенда) проксю можно одним
кликом импортировать в этот редактируемый список и затем переопределить.
