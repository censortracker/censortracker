...
4. **«Обрезать хост до второго уровня» — не то же самое, что «домен сайта».**
   ...
   сессии рвались бы при переходе между поддоменами. Обход останавливается, не доходя
   до голого публичного суффикса: запись `com` могла появиться только из
   испорченного списка, а уважить её значило бы завернуть в проксю весь
   интернет.
